...
class SignUpWidget(QWidget):
    ...
    def initUI(self):
        ...
        self.pswlabel.setFont(QFont("仿宋", 15))
        ...
        self.againpswlabel.setFont(QFont("仿宋", 15))
        ...
        self.maillabel.setFont(QFont("仿宋", 15))
        ...
        self.mailedit.setFont(QFont("仿宋", 12))
        ...
        self.signupbutton.setFont(QFont("仿宋", 15))
    ...
    def SignUp(self):
        ...
        if(id == '' or psw == '' or againpsw == '' or name == '' or mail == ''):#验证表单是否为空
            ...
            if(re.match(r'^[0-9a-zA-Z\_\-]+(\.[0-9a-zA-Z\_\-]+)*@[0-9a-zA-Z]+(\.[0-9a-zA-Z]+){1,}$', mail)):#检验邮箱格式正确性
                ...
                db.setDatabaseName('./db/quantXH.db')
                db.open()
                query = QSqlQuery()
