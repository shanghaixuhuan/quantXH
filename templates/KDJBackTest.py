...
from strategies.KDJ_backtest import KDJtest
from templates.BackTestResult import BackTestResult
from PyQt5.QtCore import Qt


class KDJBackTest(QDialog):
    def __init__(self):
        super(KDJBackTest,self).__init__()
        self.codepool = ["000001","000002","000004",]
        self.initUI()

    def initUI(self):
        self.resize(900,600)
        self.setWindowTitle("QUANT XH 金融终端——KDJ指标回测")
        ...
        self.nedit.setText("9")
        self.nedit.setFont(QFont("仿宋", 12))
        self.nedit.setFixedSize(50, 30)
        self.m1label = QLabel()
        self.m1label.setText("M1:")
        self.m1label.setFont(QFont("仿宋", 15))
        self.m1edit = QTextEdit()
        self.m1edit.setText("3")
        self.m1edit.setFont(QFont("仿宋", 12))
        self.m1edit.setFixedSize(50, 30)
        self.m2label = QLabel()
        self.m2label.setText("M2:")
        self.m2label.setFont(QFont("仿宋", 15))
        self.m2edit = QTextEdit()
        self.m2edit.setText("3")
        self.m2edit.setFont(QFont("仿宋", 12))
        self.m2edit.setFixedSize(50, 30)

        self.texttb = QTextBrowser()
        self.texttb.setFont(QFont("仿宋", 10))
        self.texttb.setFixedSize(300, 150)
        self.texttb.setText("KDJ三个值整体处于20以下的话，显示市场为超卖区；如果整体处于80以上的话则代表市场显示为超买区。")
        ...
        self.h22box.addStretch(1)
        self.h22box.addWidget(self.m1label)
        self.h22box.addWidget(self.m1edit)
        self.h22box.addStretch(1)
        self.h22box.addWidget(self.m2label)
        self.h22box.addWidget(self.m2edit)
        self.h22box.addStretch(1)
    ...
    def backTest(self):
        ...
        r = KDJtest(cash=int(self.cashedit.toPlainText()))
        r.KDJ_backtest(code=self.codepool,ckstart=change_name(self.ckfromtimeedit.text()),
                        ...
                        N=int(self.nedit.toPlainText()),M1=int(self.m1edit.toPlainText()),M2=int(self.m2edit.toPlainText()))
        r.save_to_mongo()
