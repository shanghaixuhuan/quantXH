...
import qdarkstyle
from templates.StockViewer import PetViewer
from templates.ReleasePet import ReleasePetDialog
from templates.FeedBack import FeedBackDialog
from templates.ApplyAdopt import ApplyAdoptDialog
from templates.ReleasePetHistory import ReleasePetHistory
from templates.AdoptPetHistory import AdoptPetHistory
...
class UserHome(QWidget):
    ...
    def initUI(self):
        ...
        self.db.setDatabaseName('./db/quantXH.db')
        self.db.open()
