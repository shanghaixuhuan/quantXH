...
from templates.UserManage import UserManageDialog
from templates.ReceiveFeedback import ReceiveFeedbackDialog
from templates.CheckAdopt import CheckAdoptDialog
